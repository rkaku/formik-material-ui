...
import { getWallet, sendMoney } from "actionCreators";
...
const mapStateToProps = state => ({ selector: state.blockchain.wallet });

export default connect(mapStateToProps, { getWallet, sendMoney })(Wallet);
